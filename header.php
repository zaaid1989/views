...
<body class="page-header-fixed page-quick-sidebar-over-content" <?php //if ($this->session->userdata('userrole')!='Admin') echo 'oncontextmenu="return false;"'; ?>><!---***** oncontextmenu For disabling inspect element ******--->
<!-- BEGIN HEADER -->
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			...
			<img src="<?php echo base_url();?>assets/admin/layout/img/logo3.png" alt="logo" class="img-responsive custom-mobile-class" style="margin-top:5px;"/>
			</a>
