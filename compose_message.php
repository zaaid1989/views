			...
			<div class="row inbox">
				<div class="col-md-2">
					<ul class="inbox-nav margin-bottom-10">
						...
						<li class="inbox active">
							<a href="<?php echo base_url()?>inbox/index/1" class="btn" data-title="Inbox">
							Inbox
                            <span class="message_noti_up_badge" style="color:#fff;">
                              (
                                 <span class="message_noti_up" style="margin-right:0;color:#fff;"><?php echo $unread;?>
                                 </span>
                               )
                               </span>
                            </a>
						...
						<li class="sent">
							<a class="btn" href="<?php echo base_url()?>inbox/sentmessages/1" data-title="Sent">
							Sent </a>
							<b></b>
						</li>
						<li class="trash">
							<a class="btn" href="<?php echo base_url()?>inbox/trash/1" data-title="Trash">
							Trash </a>
							<b></b>
						</li>
					</ul>
				...
				<div class="col-md-10">
					...
					<div class="inbox-content">
                        ...
                        <form class="inbox-compose form-horizontal" id="fileupload" action="<?php echo base_url();?>inbox/sendmessage" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="inbox-form-group mail-to">
                                ...
                                <div class="controls controls-to">
                                    <select id="example-getting-started" multiple="multiple" name="to">
                                        <?php 
											  $dbres = $this->db->query("SELECT * FROM user where delete_status = '0' ORDER BY  `fk_office_id` ,  `userrole` ASC ");
											  $userdataemails=$dbres->result_array();
											  foreach($userdataemails as $email)
											  {
											?>
                                        		<option value="<?php echo $email['id']?>"><?php echo $email['first_name']?></option>
                                        	<?php 
											  }
											?>
                                    </select>
