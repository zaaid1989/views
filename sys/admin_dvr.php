              ...
              <div class="table-toolbar">
              		...
              		<div class="portlet-body flip-scroll">
                            <?php
							  ...
							  ?>
                            <div class="row">
                            	<form method="post" action="<?php echo base_url();?>sys/get_date_dvr_for_admin">
                                <div class="col-md-4">
						...
						function get_current_date_values()
						{
						  ...
						  $.ajax({
							url: "<?php echo base_url();?>sys/get_date_dvr_for_admin",
							type: 'POST',
							data: formdata,
						...
						function get_egn_dvr(engineer_id)
						{
						  ...
						  $.ajax({
							url: "<?php echo base_url();?>sys/get_egn_dvr_ajax_for_admin",
							type: 'POST',
							data: formdata,
							success: function(msg){
								$(".engineer_dvrs").html(msg);
					...
					if (isset($get_sup_dvr) && sizeof($get_sup_dvr) == "0") 
					   ...
					   elseif(isset($get_sup_dvr) && sizeof($get_sup_dvr) != "0") 
					  {
							foreach($get_sup_dvr as $sup_dvr)
							{
								...
								echo '</textarea> </td>';
								echo '<td>
															<a class="btn btn default yellow-gold" href="'. base_url() .'sys/update_dvr_project/'.$sup_dvr['pk_dvr_id'].'">
																Update
