              ...
              <div class="col-md-12">
                      ...
                      <div class="portlet box red-intense">
                        ...
                        <div class="portlet-body form"> 
                          <!-- BEGIN FORM-->
                          <form  action="<?php echo base_url(); ?>sys/insert_complaint"  enctype="multipart/form-data" class="form-horizontal" method="post">
                            <div class="form-body">
                                 ...
                                 /*Ajax fucntion*/
                                   ...
                                   function select_contact_no(va_nam)
                                   {
                                    ...
                                    $.ajax({
                                      ...
                                      /*$.ajax({
                                      url: "<?php echo base_url();?>sys/client_hidden_id_ajax",
                                      type: 'POST',
                                      data: formdata,
                                      success: function(msg){
                                          $("#client_id").val(msg);
