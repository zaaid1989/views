                          ...
                          <div class="portlet-body">
                            <div class="table-toolbar">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="btn-group">
                                    <a href="<?php echo base_url();?>sys/add_product" id="sample_editable_1_new" class="btn light-blue"> 
											  ...
											  <tr class="odd gradeX">
											   ...
											   ?>
												  ...
												  <td>
                                                      ...
                                                      href="<?php echo base_url();?>sys/update_product/<?php echo $get_users_list["pk_product_id"];?>">
                                                      	Update <i class="fa fa-edit"></i>
                                                      </a>
                                                      <a class="btn btn default red-thunderbird"  
                                                        href="<?php echo base_url();?>sys/delete_product/<?php echo $get_users_list["pk_product_id"];?>"
