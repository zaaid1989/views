       ...
       <div class="row">
		...
		<div class="portlet light bg-inverse">
						...
						<?php
							  ...
							  ?>
						        <div class="row">
                            	<form method="get" action="<?php echo base_url();?>sys/sap_dvr_history_new">
					...
					if (isset($get_sup_dvr) && sizeof($get_sup_dvr) == "0") 
					   ...
					   elseif(isset($get_sup_dvr) && sizeof($get_sup_dvr) != "0") 
					  {
							foreach($get_sup_dvr as $sup_dvr)
							{
								...
								if ($k==1)
									echo '<td>
															<a class="btn btn default yellow-gold" href="'. base_url() .'sys/update_dvr_project/'.$record_id.'?engineer='.$engineer.'&start_mydate='.$_GET['start_mydate'].'&end_mydate='.$_GET['end_mydate'].'">
																Edit
																<i class="fa fa-edit"></i>
															</a>
															
															<a class="btn btn default red-thunderbird" onClick="return confirm(\'Are you sure you want to delete?\')"  href="'. base_url() .'sys/delete_dvr/'.$record_id.'?engineer='.$engineer.'&start_mydate='.$_GET['start_mydate'].'&end_mydate='.$_GET['end_mydate'].'"  >
																Delete
									...
									echo '<td>
															<a class="btn btn default yellow-gold" href="'. base_url() .'sys/update_vs_project/'.$record_id.'?engineer='.$engineer.'&start_mydate='.$_GET['start_mydate'].'&end_mydate='.$_GET['end_mydate'].'">
																Edit
																<i class="fa fa-edit"></i>
															</a>
															
															<a class="btn btn default red-thunderbird" onClick="return confirm(\'Are you sure you want to delete?\')" href="'. base_url() .'sys/delete_vs/'.$record_id.'?engineer='.$engineer.'&start_mydate='.$_GET['start_mydate'].'&end_mydate='.$_GET['end_mydate'].'">
																Delete
																<i class="fa fa-trash-o"></i>
															</a>
														  </td>'; */
