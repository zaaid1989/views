...
?>
      ...
      <div class="page-bar">
          <ul class="page-breadcrumb">
			  ...
			  <li>
                  <a href="<?php echo base_url();?>sys/all_leaves">All Leaves</a>
                  <i class="fa fa-angle-right"></i>
              </li>
              <li>
                  Leave Form
      ...
      <div class="row">
        <div class="col-md-12"> 
          ...
          <div class="portlet box blue">
           ...
           <form class="form-horizontal form-bordered form-row-stripped" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>sys/insert_leave" onSubmit="return confirm('Approval of any leave is mandatory.You can not avail any leave until it is permitted by administration');">
            <div class="form-body">
				...
				function show_amount(fine_id)
				{
				  ...
				  $.ajax({
					url: "<?php echo base_url();?>sys/select_leave_code_amount_ajax",
					type: 'POST',
					data: formdata,
				...
				function show_leaves_remaining(employee_id)
				{
				  ...
				  $.ajax({
					url: "<?php echo base_url();?>sys/select_remaining_leaves_ajax",
					type: 'POST',
					data: formdata,
					success: function(msg){
						//these two are inner ajax
                ...
                <div class="form-actions">
                  <div class="row">
                   ...
                   <!--   <a href="<?php echo base_url();?>sys/all_leaves" class="btn default grey">Cancel</a> -->
                    </div>
                  </div>
                </div>
           	 </div>
