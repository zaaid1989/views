<?php $this->load->view('header');?>
                    ...
                    <div class="page-bar">
                      <ul class="page-breadcrumb">
                        ...
                        <li> <a href="<?php echo site_url(); ?>sys/get_employees">Employees</a> <i class="fa fa-angle-right"></i> </li>
						<li> Add Employee </li>
                      </ul>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="portlet-body form"> 
								  ...
								  ?>
                                    <!-- BEGIN FORM-->
                                    <form  action="<?php echo base_url(); ?>sys/insert_employee"  id="submit_form2" method="post" 
