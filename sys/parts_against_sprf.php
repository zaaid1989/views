									 ...
									 if (sizeof($rt) == "0") {
											...
											//  echo "<td>".$spr['complaint_status']."</td>";
											  ...
											  echo "<td>";
											   ...
											   echo '<a class="btn btn-sm default green-meadow-stripe" href="'.base_url().'sys/supervisor_sprf/'.$spr['pk_complaint_id'].'">SPRF <i class="fa fa-eye"></i></a>';
											   echo '<a class="btn btn-sm default blue-stripe" href="'.base_url().'sys/ledger?part='.$spr['pk_part_id'].'">Ledger <i class="fa fa-eye"></i></a>';
											   ...
											   echo '<a class="btn btn-sm default red-stripe" href="'.base_url().'sys/delete_sprf/'.$spr['pk_sprf_id'].'" onClick="return confirm(\'Are you sure you want to delete?\')">Delete <i class="fa fa-trash"></i></a>';
											  echo "</td>";
											  echo "</tr>";
										  }
									  }
