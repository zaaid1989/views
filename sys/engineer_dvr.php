<?php $this->load->view('header');?>
		...
		<form method="post" action="<?php echo base_url();?>sys/insert_dvr_engineer">
                    ...
                    <td> 
                            ...
                            <select class="form-control  " name="customer[0]" id="customer0"  onchange="show_cities(this.value,0)">
							  ...
							  <?php $quw="SELECT * from user where id =  '".$this->session->userdata('userid')."'";
								...
								$qu="SELECT * from tbl_clients where fk_office_id IN(".$rtw[0]['fk_office_id'].")";
								$gh=$this->db->query($qu);
								$rt=$gh->result_array();
								foreach($rt as $value)
								  {
