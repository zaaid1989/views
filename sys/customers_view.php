                          ...
                          <div class="portlet-body">
                            <div class="table-toolbar">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="btn-group">
                                    <a href="<?php echo base_url();?>sys/add_customer" id="sample_editable_1_new" class="btn green"> Register New Customer <i class="fa fa-plus"></i> </a>
                                  </div>
                                </div>
                                <div class="col-md-6">
										...
										//do somthing  
										  ...
										  foreach ($get_customers_listt as $customers_list) {
											  ...
											  <tr class=" odd gradeX">
                                                  ...
                                                  <td>
                                                     <a class="btn btn-sm default blue" href="<?php echo base_url();?>sys/edit_customer/<?php echo $customers_list['pk_client_id'];?>">
