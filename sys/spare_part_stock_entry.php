      ...
      <div class="row">
        <div class="col-md-12">
                <div class="portlet box grey-gallery">
                  ...
                  <?php	?>
                   <!-- BEGIN FORM-->
            <form action="<?php echo base_url();?>sys/spare_part_stock_entry_insert" class="horizontal-form" method="post"  enctype="multipart/form-data">
                <div class="form-body">
				<div class="">
				<!--
	  <h3>
	...
	<div class="row bg-yellow-zed">
			...
			<div class="form-group" id="equipment_serial_div" <?php if ($t != "" && $t=="Warranty Claim") echo ''; else echo 'style="display:none"'; ?>>
				 ...
				 function select_description(part_id)
				 {
					...
					$.ajax({
					url: "<?php echo base_url();?>sys/order_reference_ajax",
					type: 'POST',
					data: formdata2,
					success: function(msg){
