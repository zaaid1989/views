            ...
            <input type="hidden" name="sprf_date" value="<?php echo date('Y-m-d', strtotime($date));?>" />
             ...
             <table class="table table-striped table-bordered table-hover flip-content" id="sample_20">
                     ...
                     <!--         <option value="old inventory" <?php if($sprf['part_source']=='old inventory'){ echo 'selected="selected"';}?>>Old&nbsp;Inventory</option> -->
						  ...
						  ?>
                                <a class="btn btn default red-thunderbird"  
                                  href="<?php echo base_url();?>sys/delete_sprf/<?php echo $sprf["pk_sprf_id"].'?complaint_id='.$this->uri->segment(3);?>"
			  ...
			  function get_des_and_unitprice(part_id)
			  {
				  ...
				  $.ajax({
					url: "<?php echo base_url();?>sys/get_des_ajax",
					type: 'POST',
					data: formdata,
					success: function(msg){
					 ...
					 $.ajax({
					url: "<?php echo base_url();?>sys/get_par_image_ajax",
					type: 'POST',
					data: formdata,
					success: function(msg){
						$(".part_image").html(msg);
					...
					$.ajax({
					url: "<?php echo base_url();?>sys/get_unitprice_ajax",
					type: 'POST',
					data: formdata,
					success: function(msg){
						$(".unit_price").val(msg);
					...
					$.ajax({
					url: "<?php echo base_url();?>sys/get_stock_quantities_table_ajax",
					type: 'POST',
					data: formdata,
					success: function(msg){
