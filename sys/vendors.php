                  ...
                  <div class="portlet-body">
                    <div class="table-toolbar">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="btn-group">
                            <a href="<?php echo base_url();?>sys/vendor_registration" id="sample_editable_1_new" class="btn light-blue"> 
                            	Register New Vendor
							...
							<tr class="odd gradeX">
								...
								<td>
									<a class="btn btn-sm default light-blue"  
									 href="<?php echo base_url();?>sys/update_vendor/<?php echo $get_users_list["pk_vendor_id"];?>">
									 <i class="fa fa-edit"></i>
										Update
									 </a>
									<a  class="btn btn-sm default red-thunderbird"  
									href="<?php echo base_url();?>sys/delete_vendor/<?php echo $get_users_list["pk_vendor_id"];?>"
