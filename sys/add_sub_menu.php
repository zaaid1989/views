...
?>
      ...
      <h3 class="page-title">  Add Submenu <small></small> </h3>
      ...
      <div class="page-bar">
        ...
        <ul class="page-breadcrumb">
          ...
          <li> <a href="<?php echo site_url(); ?>sys/sub_menu">Submenu</a> <i class="fa fa-angle-right"></i></li>
		  <li> Add Submenu </li>
        ...
        <div class="col-md-12">
                ...
                <div class="portlet box blue-steel">
                  ...
                  <div class="portlet-title">
                    ...
                    <div class="caption"> <i class="fa fa-edit"></i>Add Submenu Details </div>
                  ...
                  <?php
                   ...
                   <!-- BEGIN FORM-->
            <form action="<?php echo base_url();?>sys/insert_submenu" class="form-horizontal" method="post">
                <div class="form-body">
                 <?php
				 ...
				 <div class="form-group">
                    ...
                    <div class="col-md-5">
                       <select class="from_control input-large" name="fk_main_menu_id" required>
                       ...
                       <?php 
						  ...
						  foreach($rt as $result)
						  {
						   ?>
							...
							<?php if($result["pk_main_menu_id"]==$this->uri->segment(3)){?> selected="selected"<?php }?>
							>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="sub_menu" value="" required>
                    </div>
                </div>
				<div class="form-group">
                    <label class="col-md-3 control-label">Pre</label>
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="pre" value="" >
                    </div>
                </div>
				<div class="form-group">
			...
			<!--	
					...
					<div class="col-md-9">
						<div id="spinner1">
							<div class="input-group input-small">
								<input type="text" class="spinner-input form-control" maxlength="3" name="order" value="" readonly>
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="checkbox" name="Admin" class="make-switch" data-on-color="primary" data-off-color="danger" data-on-text="Yes" data-off-text="No" value="1"  >
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="checkbox" name="secratery" class="make-switch" data-on-color="primary" data-off-color="danger" data-on-text="Yes" data-off-text="No" value="1"  >
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="checkbox" name="Supervisor" class="make-switch" data-on-color="primary" data-off-color="danger" data-on-text="Yes" data-off-text="No" value="1"  >
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="checkbox" name="FSE" class="make-switch" data-on-color="primary" data-off-color="danger" data-on-text="Yes" data-off-text="No" value="1"  >
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-9">
						<input type="checkbox" name="Salesman" class="make-switch" data-on-color="primary" data-off-color="danger" data-on-text="Yes" data-off-text="No" value="1"  >
					</div>
				</div>
                        ...
                        <div class="col-md-6">
                            <div class="row">
								...
								<?php if ($this->uri->segment(3)!="") { ?>
                                    <input type="hidden" name="re_id" value="<?php echo $this->uri->segment(3); ?>">
								<?php } ?>
