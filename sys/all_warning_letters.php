                      ...
                      <?php
						...
						if($this->session->userdata('userrole')=='secratery' || $this->session->userdata('userrole')=='Admin' )
							{ ?>
                                ...
                                <div class="col-md-6">
                                  <div class="btn-group">
                                    <a href="<?php echo base_url();?>sys/warning_letter" id="sample_editable_1_new" class="btn green"> 
                                ...
                                foreach ($rt22 as $get_users_list) {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            ...
                                            href="<?php echo base_url();?>sys/update_warning_letter/<?php echo $get_users_list["pk_warning_letter_id"];?>">
