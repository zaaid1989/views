                  ...
                  <div class="portlet-body">
                    <div class="table-toolbar">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="btn-group">
                            <a href="<?php echo base_url();?>sys/equipment_registration" id="sample_editable_1_new" class="btn light-blue"> 
                                  ...
                                  foreach ($rt as $get_users_list) {
                                      ...
                                      <tr class="odd gradeX">
                                          ...
                                          <td>
                                              ...
                                              href="<?php echo base_url();?>sys/update_equipment/<?php echo $get_users_list["pk_instrument_id"];?>">
                                              ...
                                              <a class="btn default red-thunderbird" onClick="return confirm('Are you sure you want to delete?')"
                                                 href="<?php echo base_url();?>sys/delete_equipment/<?php echo $get_users_list["pk_instrument_id"];?>">
