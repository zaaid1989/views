                  ...
                  <div class="portlet-body">
                    <div class="table-toolbar">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="btn-group">
                            <a href="<?php echo base_url();?>sys/aux_equipment_registration" id="sample_editable_1_new" class="btn light-blue"> 
                                      ...
                                      <tr>
										...
										WHERE tbl_instruments.fk_category_id!=1 AND tbl_products.status=0 AND tbl_instruments.pk_instrument_id='$me'");
                                          ...
                                          <td> <!-- Actions -->
                                              ...
                                              href="<?php echo base_url();?>sys/update_aux_equipment/<?php echo $get_users_list["pk_instrument_id"];?>">
                                              ...
                                              <a class="btn default red-thunderbird" onClick="return confirm('Are you sure you want to delete?')"
                                                 href="<?php echo base_url();?>sys/delete_aux_equipment/<?php echo $get_users_list["pk_instrument_id"];?>">
