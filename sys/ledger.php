...
#sample_zz { display:none }
					...
					<form method="get" action="<?php echo base_url();?>sys/ledger<?php //echo $part_id; ?>">
							  ...
							  $balance = $balance + $stock_entry['stock'];
                                  ...
                                  <tr class="odd gradeX">
												...
												if ($stock_entry['stock_type']=='Part Swap') {
													...
													*/
													if ($stock_entry["source_complaint_id"]== '0') echo "Complaint not found";
														...
														if ($source_ts!='')
															echo '<a  href="'.base_url().'sys/technical_service_pvr/'.$stock_entry["source_complaint_id"].'">'.$source_ts.'</a>';
														else
													...
													echo '<a  href="'.base_url().'sys/technical_service_pvr/'.$stock_entry["fk_complaint_id"].'">'.echozero($stock_entry['ts_number']).'</a>';//echo echozero($stock_entry['ts_number']);
											?> 
									  </td>
									  ...
									  <td> <center>
										  ...
										  href="<?php echo base_url();?>sys/delete_stock/<?php echo $stock_entry["pk_stock_id"]; ?>?part=<?php echo $part_id; ?>"
