...
?>
      ...
      <h3 class="page-title">  Add Main Menu <small></small> </h3>
      ...
      <div class="page-bar">
        ...
        <ul class="page-breadcrumb">
          ...
          <li> <a href="<?php echo site_url(); ?>sys/main_menu">Main Menu</a> <i class="fa fa-angle-right"></i></li>
		  <li> Add Main Menu </li>
        ...
        <div class="col-md-12">
                ...
                <div class="portlet box green-jungle">
                  ...
                  <div class="portlet-title">
                    ...
                    <div class="caption"> <i class="fa fa-edit"></i>Add Main Menu Details </div>
                  ...
                  <?php
                   ...
                   <!-- BEGIN FORM-->
            <form action="<?php echo base_url();?>sys/insert_mainmenu" class="form-horizontal" method="post">
                <div class="form-body">
                 <?php
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="main_menu" value="" required>
                    </div>
                </div>
