                ...
                <div class="portlet-body">
                  <div class="table-toolbar">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="btn-group">
                          <a href="<?php echo base_url();?>sys/add_city" id="sample_editable_1_new" class="btn purple-seance"> 
                              Add New City
                                ...
                                foreach ($rt22 as $get_city_list) {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            ...
                                            href="<?php echo base_url();?>sys/update_city/<?php echo $get_city_list["pk_city_id"];?>">
                                            ...
                                            href="<?php echo base_url();?>sys/delete_city/<?php echo $get_city_list["pk_city_id"];?>"
