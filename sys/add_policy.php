...
<script src="//cdn.ckeditor.com/4.5.11/standard/ckeditor.js"></script>
      ...
      <div class="page-bar">
        ...
        <ul class="page-breadcrumb">
          ...
          <li> <a href="<?php echo site_url();?>sys/policies">Policies</a> <i class="fa fa-angle-right"></i> </li>
        ...
        <div class="col-md-12">
                ...
                <div class="portlet box green-seagreen">
                  ...
                  <?php
                   ...
                   <!-- BEGIN FORM-->
            <form action="<?php echo base_url();?>sys/add_policy_insert" class="form-horizontal" method="post">
                <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
								...
								<!--	<a href="<?php echo site_url();?>sys/policies" class="btn default">Cancel</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
