<?php $this->load->view('header');?>
      ...
      <div class="page-bar">
        ...
        <ul class="page-breadcrumb">
          ...
          <li> <a href="<?php echo site_url();?>sys/news">News</a> <i class="fa fa-angle-right"></i> </li>
        ...
        <div class="col-md-12">
                ...
                <div class="portlet box green-seagreen">
                  ...
                  <?php
                   ...
                   <!-- BEGIN FORM-->
            <form action="<?php echo base_url();?>sys/add_news_insert" class="form-horizontal" method="post">
                <div class="form-body">
