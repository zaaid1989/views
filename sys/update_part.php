        ...
        <div class="col-md-12">
                ...
                <div class="portlet box green-seagreen">
                  ...
                  <?php
                   ...
                   <!-- BEGIN FORM-->
            <form action="<?php echo base_url();?>sys/part_update_insert" class="form-horizontal" method="post" id="target" enctype="multipart/form-data">
                <div class="form-body">
				 ...
				 function select_products(vendor_id)
				 {
				  ...
				  $.ajax({
					url: "<?php echo base_url();?>sys/select_products",
					type: 'POST',
					data: formdata,
