                      ...
                      <div class="col-md-12">
                        <div class="portlet box yellow-gold" id="form_wizard_1">
							...
							<div class="tools hidden-xs">
								...
								?>
                                    <!-- BEGIN FORM-->
                                    <form  action="<?php echo base_url(); ?>sys/run_update_employee/<?php echo $get_employee_lists[0]['id']?>"  id="submit_form2" method="post" 
                                    ...
                                    <div class="form-actions">
										<div class="row">
											...
											<!--	<a href="<?php echo site_url();?>sys/get_employees" class="btn default">Cancel</a> -->
											</div>
										</div>
									</div>
                                        </div>
