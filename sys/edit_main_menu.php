      ...
      <div class="row">
        ...
        <div class="col-md-12">
                ...
                <div class="portlet box green-jungle">
				 ...
				 // print_r($icons);
                   ...
                   <!-- BEGIN FORM-->
            <form action="<?php echo base_url();?>sys/update_mainmenu" class="form-horizontal" method="post">
                <div class="form-body">
                 <?php
		...
		<div class="portlet light bg-inverse">
						  ...
						  <div class="row">
							<div class="col-md-6">
							  <div class="btn-group">
								<a href="<?php echo base_url();?>sys/add_sub_menu/<?php echo $this->uri->segment(3); ?>" class="btn yellow-crusta"> 
