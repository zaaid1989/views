<?php $this->load->view('header');?>
      ...
      <div class="page-bar">
        ...
        <ul class="page-breadcrumb">
          ...
          <li> <a href="<?php echo base_url() . 'sys/areas'; ?>">Areas<i class="fa fa-angle-right"></i> </li>
        ...
        <div class="col-md-12">
                ...
                <div class="portlet box purple-seance">
                  ...
                  <?php
                   ...
                   <!-- BEGIN FORM-->
            <form action="<?php echo base_url();?>sys/add_area_insert" class="form-horizontal" method="post">
                <div class="form-body">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-offset-6 col-md-6">
                                 ...
                                 <!--   <a href="<?php echo base_url() . 'sys/areas'; ?>" class="btn default">Cancel</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
