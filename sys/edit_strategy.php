...
?>
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet box green-seagreen">
           ...
           <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>sys/update_strategy">
            ...
            <div class="form-actions">
              <div class="row">
				...
				<a class="btn btn default red" href="<?php echo base_url();?>sys/disapprove_strategy/<?php echo $strategy_id;?>">
                                                      	Not Approved
                                                      </a>
				<?php } ?>
                </div>
