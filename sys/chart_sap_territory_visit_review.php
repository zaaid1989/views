				...
				<div class="portlet light bg-inverse" >
						...
						<div class="portlet-body">
						        <div class="row">
									<div class="col-md-12">
									<p>
		- Each Project is divided into 5 bars depending on the last visit date.
...
<br/>- <span style="color:#000000;font-weight: 900;">Black</span> = No Last Visit
...
<?php $this->load->view('sys/chart_sap_territory_visit_review_view',$data);?>
