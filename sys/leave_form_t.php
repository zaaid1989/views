      ...
      <div class="row">
        <div class="col-md-12"> 
          ...
          <div class="portlet box blue">
           ...
           <form class="form-horizontal form-bordered form-row-stripped" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>sys/insert_temporary_leaves" onsubmit="return checkForm(this);">
