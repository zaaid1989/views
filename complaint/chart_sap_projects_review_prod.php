				...
				<div class="portlet light bg-inverse" >
						...
						<div class="portlet-body">
						        <div class="row">
									<div class="col-md-12">
									<p>
									- Each Product Category has a separate bar and number on top of each bar is the total number of projects of this Category.
									...
									<br/>- Move the cursor on the bar to see further details of Customer Name – (Last Date of visit). 
...
<?php if ($this->session->userdata('userrole')=='Admin' || $this->session->userdata('userrole')=='secratery'){ ?>		
		...
		<div class="portlet light bg-inverse" >
						...
						<div class="portlet-body">
						        <div class="row">
                            	<form method="get" action="<?php echo base_url();?>complaint/chart_sap_projects_review_prod">
                                <div class="col-md-4">
                            		<div class="form-group">
                            			<select name="territory" id="territory" class="form-control" onchange="territory_changed()" required>
...
<?php } ?>
					...
					<div class="portlet solid bordered light bg-inverse ">
						...
						<div class="scroller" style="height:400px" data-always-visible="1" data-rail-visible="1" data-rail-color="blue" data-handle-color="red"> -->
								<div id="container" style="width: 100%; height: 600px; margin-left:20px; "></div> 	 
						<!--	</div> -->
						</div>
						<!-- End Portlet Body -->
					</div>
...
$(document).ready(function() {
	...
	var options = {
        ...
        title: {
            text: 'SAP Projects Review - Products'
        },
		...
		<?php 
			...
			foreach ($project_statuses AS $project_status) {
				...
				foreach ($category_ids AS $category_id) {
					...
					/*$pq = $this->db->query("select business_data.*,tbl_clients.client_name,tbl_cities.city_name
					from business_data
					LEFT JOIN tbl_clients ON tbl_clients.pk_client_id = business_data.Customer
					LEFT JOIN tbl_cities ON tbl_cities.pk_city_id = tbl_clients.fk_city_id
