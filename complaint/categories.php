                ...
                <div class="portlet-body">
                  <div class="table-toolbar">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="btn-group">
                          <a href="<?php echo base_url();?>complaint/add_category" id="sample_editable_1_new" class="btn light-blue"> 
                              Add New Category
                                ...
                                foreach ($rt22 as $get_users_list) {
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
													...
													href="<?php echo base_url();?>complaint/delete_category/<?php echo $get_users_list["pk_category_id"];?>"
