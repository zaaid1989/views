<?php $this->load->view('header');?>
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
            Complaint <small>Verify TS Reports</small>
            </h3>
            <div class="page-bar">
              ...
              <div class="col-md-12"> 
                ...
                <div class="portlet box yellow-crusta">
                  <div class="portlet-title">
                    <div class="caption"> <i class="fa fa-globe"></i>Complaints Pending Verification</div>
                     ...
                     <table class="table table-striped table-bordered table-hover flip-content" id="sample_2">
                      ...
                      <tbody>
                        <?php
							...
							$dbres2 = $this->db->query("SELECT * FROM user  where id='".$this->session->userdata('userid')."'");
                                ...
                                //do somthing  
                                  ...
                                  foreach ($dbresResult as $complaint_list) {
                                      ...
                                      <tr class=" <?php if($complaint_list['urgent_priority']==1){ echo "danger even";} else { echo "odd gradeX";}?>">
                                          ...
                                          <td>
                                          <a class="btn btn-default" href="<?php echo base_url();?>complaint/ts_report_supervisor/<?php echo $complaint_list["pk_complaint_id"] ?>">
                                          	Open Form
                                          </a>
                                          </td>
