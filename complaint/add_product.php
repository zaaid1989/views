<?php $this->load->view('header');?>
      ...
      <div class="page-bar">
        ...
        <ul class="page-breadcrumb">
          ...
          <li> <a href="<?php echo base_url() . 'complaint/products'; ?>">Products</a> <i class="fa fa-angle-right"></i> </li>
          <li> Add Product </li>
              ...
              <div class="tab-pane active" id="tab_0">
                ...
                <div class="portlet box green">
                  ...
                  <?php
                   ...
                   <!-- BEGIN FORM-->
            <form action="<?php echo base_url();?>complaint/add_product_insert" class="form-horizontal" method="post">
                <div class="form-body">
                ...
                <script type="text/javascript">
					function show_cities(category)
					{
					  ...
					  $.ajax({
						url: "<?php echo base_url();?>complaint/vendors_based_on_category_ajax",
						type: 'POST',
						data: formdata,
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                              ...
                              <!--      <a href="<?php echo base_url() . 'complaint/products'; ?>" class="btn default">Cancel</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
