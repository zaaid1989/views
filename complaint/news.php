                          ...
                          <div class="portlet-body">
                            <div class="table-toolbar">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="btn-group">
                                    <a href="<?php echo base_url();?>complaint/add_news" id="sample_editable_1_new" class="btn green-seagreen"> 
										  ...
										  foreach ($rt22 as $get_users_list) {
											  ...
											  <tr class="odd gradeX">
												  ...
												  <td>
                                                      ...
                                                      href="<?php echo base_url();?>complaint/update_news/<?php echo $get_users_list["pk_news_id"];?>">
													  <i class="fa fa-edit"></i>
                                                      	Update
                                                      </a>
                                                      <a class="btn btn-sm default red-thunderbird"  
                                                      href="<?php echo base_url();?>complaint/delete_news/<?php echo $get_users_list["pk_news_id"];?>"
