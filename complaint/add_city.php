<?php $this->load->view('header');?>
      ...
      <div class="page-bar">
        ...
        <ul class="page-breadcrumb">
          ...
          <li> <a href="<?php echo base_url() . 'complaint/cities'; ?>">Cities</a> <i class="fa fa-angle-right"></i> </li>
        ...
        <div class="col-md-12">
                ...
                <div class="portlet box purple-seance">
                  ...
                  <?php
                   ...
                   <!-- BEGIN FORM-->
            <form action="<?php echo base_url();?>complaint/add_city_insert" class="form-horizontal" method="post">
                <div class="form-body">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-offset-6 col-md-6">
                                 ...
                                 <!--   <a href="<?php echo base_url() . 'complaint/cities'; ?>" class="btn default">Cancel</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
