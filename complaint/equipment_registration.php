<?php $this->load->view('header');?>
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet box blue">
           ...
           <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>complaint/insert_equipment_registration">
            ...
            <div class="form-body">
			  ...
			  <script type="text/javascript">
				...
				function show_product(vendor_id)
				{
				  ...
				  $.ajax({
					url: "<?php echo base_url();?>complaint/products_based_on_vendor_category_ajax",
					type: 'POST',
					data: formdata,
					success: function(msg){
						//these two are inner ajax
