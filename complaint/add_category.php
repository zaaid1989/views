              ...
              <div class="tab-pane active" id="tab_0">
                ...
                <div class="portlet box green">
                  ...
                  <?php
                   ...
                   <!-- BEGIN FORM-->
            <form action="<?php echo base_url();?>complaint/add_category_insert" class="form-horizontal" method="post">
                <div class="form-body">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                  ...
                                  <!--  <a href="<?php echo base_url() . 'complaint/categories'; ?>" class="btn default">Cancel</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
