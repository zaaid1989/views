                  ...
                  <div class="table-toolbar">
						...
						if($this->session->userdata('userrole')=='secratery' || $this->session->userdata('userrole')=='Admin' || ($this->session->userdata('userrole')=='Supervisor' && $i==2) || ($sap_supervisor =="1" && $i==3))
							{ ?>
                                ...
                                <div class="col-md-6">
                                  <div class="btn-group">
                                    <a href="<?php echo base_url();?>complaint/fine" id="sample_editable_1_new" class="btn blue-steel"> 
                                ...
                                foreach ($rt22 as $get_users_list) {
									...
									<?php if ($i!=2 && $i!=3) { ?>
                                        <td>
                                            ...
                                            href="<?php echo base_url();?>complaint/update_fine/<?php echo $get_users_list["pk_fine_id"];?>">
                                            ...
                                            href="<?php echo base_url();?>products/delete_fine/<?php echo $get_users_list["pk_fine_id"];?>">
