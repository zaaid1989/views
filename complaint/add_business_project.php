...
<?php $redirect_customer="no";?>
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet box green-seagreen">
           ...
           <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>complaint/insert_business_project">
            ...
            <div class="form-body">
			  ...
			  <script type="text/javascript">
				function show_cities(client_id)
				{
				  ...
				  $.ajax({
					url: "<?php echo base_url();?>complaint/business_project_select_city",
					type: 'POST',
					data: formdata,
					...
					//for teritory
					$.ajax({
					url: "<?php echo base_url();?>complaint/business_project_select_territory",
					type: 'POST',
					data: formdata,
					success: function(msg){
					...
					//for area
					$.ajax({
					url: "<?php echo base_url();?>complaint/business_project_select_area",
					type: 'POST',
					data: formdata,
					success: function(msg){
						$(".area_td").html(msg);
					...
					//for saps
					$.ajax({
					url: "<?php echo base_url();?>complaint/business_project_select_users",
					type: 'POST',
					data: formdata,
