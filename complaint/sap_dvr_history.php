                      ...
                      <div class="col-md-12"> 
                        ...
                        <div class="portlet box grey-cascade">
                          ...
                          <div class="portlet-body">
                            ...
                            <form method="post" action="<?php echo base_url();?>complaint/get_date_dvr_from_form_sbumit">
                              <div class="row">
                                  <input type="hidden" name="engineer" id="engineer" value="<?php echo $this->session->userdata('userid');?>" />
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>&nbsp;</label>
                                            <input type="submit"  class="btn btn-default blue" value="Search" style="margin-top:26px;">
                                        </div>
                                    </div>
                               </div>
                               </form>
