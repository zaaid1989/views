<?php $this->load->view('header');?>
		...
		<form method="post" action="<?php echo base_url();?>complaint/insert_dvr_engineer">
              ...
              <div class="table-toolbar">
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <th colspan="2"  style="width:420px !important"> Time </th>
                    
                    <th style="width:120px !important" > City </th>

                    <th style="width:120px !important"> Customer</th>
                    
                    <th style="width:120px !important"> Business Project </th>
                    <th style="width:100px !important"> Description </th>
                    <th style="width:120px !important"> Timeline  </th>

                    <th style="width:160px !important"> Working Details/ Discussion Summary </th>
                    
                    <th style="width:100px !important"> Next Plan  </th>
              ...
              <div class="table-scrollable"> 
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <th  style=" padding-right:150px;"> City</th>
                    
                    <th  style=" padding-right:150px;"> Business Project </th>
                    <th  style=" padding-right:150px;"> Business Description </th>
                    <th style="width:120px !important"> Time Elapsed  </th>

                    <th style="width:160px !important"> Working Details/ Discussion Summary </th>
                    
                    <th style="width:100px !important"> Next Plan  </th>
                    <th style="width:20px !important"> <a href="javascript:void()"><i class="fa fa-plus" onclick="add_row()"></i></a> </th>
                  </tr>
                ...
                <tbody class="append_tbody">
                  ...
                  <tr class="odd gradeX">
                    ...
                    <td> 
                            ...
                            <select class="form-control  " name="customer[0]" id="customer0"  onchange="show_cities(this.value,0)">
							  ...
							  <?php $quw="SELECT * from user where id =  '".$this->session->userdata('userid')."'";
								...
								$qu="SELECT * from tbl_clients where fk_office_id =  '".$rtw[0]['fk_office_id']."'";
								$gh=$this->db->query($qu);
								$rt=$gh->result_array();
								foreach($rt as $value)
								  {
                    ...
                    <td class="citiestd0"> 
                    <select class="form-control  " name="city[0]" id="city[0]">
                              <option value="">--Choose--</option>
                              </select>
                    </td>
                    ...
                    <td><input type="text"  readonly name="time_elaped[0]"  class="form-control time_elaped0">	</td> 
			  ...
			  <script type="text/javascript">
				...
				function fill_business_dec_and_timeelapsed(business_id,rowid)
				{
				  ...
				  else
				  {
					...
					var cutomer_id= $("#cutomer"+rowid).val();
					var city_id= $("#city"+rowid).val();
					var formdata =
					  {
