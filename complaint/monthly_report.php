...
<?php if ($this->session->userdata('userrole')=='Admin' || $this->session->userdata('userrole')=='secratery' ){ ?>		
		...
		<div class="portlet light bg-inverse">
						...
						<?php
							  ...
							  ?>
						        <div class="row">
                            	<form method="get" action="<?php echo base_url();?>complaint/monthly_report">
                                <div class="col-md-3">
                ...
                <table class="table  table-hover dataaTable" id="">
					...
					<?php if ($k==2 && ($user_role=="FSE" || $user_role=="Supervisor" )) { // Current Pending PMs
						...
						foreach ($result AS $pmc) {
							...
							echo '<td>'; ?>
							<a class="btn btn-sm default purple-stripe" href="<?php echo base_url();?>complaint/pm_form/<?php echo $pmc["pk_complaint_id"] ?>">
								PM Form 
								<i class="fa fa-eye"></i>
							  </a>
						<?php
