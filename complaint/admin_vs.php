<?php $this->load->view('header');?>
                    <!-- BEGIN PAGE HEADER-->
                    <h3 class="page-title">
                    VS <small>Individual History</small>
                    </h3>
                    <div class="page-bar">
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet box blue-madison">
            ...
            <div class="portlet-title">
              ...
              <div class="caption"> <i class="icon-doc"></i> Search VS </div>
              ...
              <div class="table-toolbar">
              			...
              			<div class="portlet-body flip-scroll">
                            ...
                            <div class="row">
                                ...
                                <form method="post" action="<?php echo base_url();?>complaint/get_date_vs_for_admin">
                                <div class="col-md-4">
						...
						function get_current_date_values()
						{
						  ...
						  $.ajax({
							url: "<?php echo base_url();?>complaint/get_date_vs_for_admin",
							type: 'POST',
							data: formdata,
						...
						function get_egn_dvr(engineer_id)
						{
						  ...
						  $.ajax({
							url: "<?php echo base_url();?>complaint/get_egn_vs_ajax_for_admin",
							type: 'POST',
							data: formdata,
							success: function(msg){
								$(".engineer_dvrs").html(msg);
                ...
                if (isset($get_sup_dvr) && sizeof($get_sup_dvr) == "0") 
					   ...
					   elseif(isset($get_sup_dvr) && sizeof($get_sup_dvr) != "0") 
					  {
						foreach($get_sup_dvr as $sup_dvr)
						{
							...
							echo '</textarea> </td>';
							echo '<td>
														<a class="btn btn default blue-madison" href="'. base_url() .'complaint/update_vs_project/'.$sup_dvr['pk_vs_id'].'">
															Update
