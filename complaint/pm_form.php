<?php $this->load->view('header');?>
      ...
      <div class="row">
        <div class="col-md-12">
				  ...
				  <?php
                    ...
                    <?php
                      if(isset($_GET['msg_mark_comp']))
						...
						if(isset($_GET['msg_mark_pend']))
                        { 
                          echo '<div class="alert alert-success alert-dismissable">  
                                  <a class="close" data-dismiss="alert">×</a>  
                                  Marked Pending Successfully.  
                                </div>';
                        }
                    ?>
					<?php
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                               ...
                               <tr class="odd gradeX">
                                 ...
                                 <td>
                                  <?php  if( $get_compalaint_result[0]['reporting_date']!='0000-00-00 00:00:00') 
								  { 
								  	echo  date('d-M-Y H:i', strtotime($get_compalaint_result[0]['reporting_date']));  
								  }?>
                                 </td>
                           </tr>
                           ...
                           <tr class="odd gradeX">
                                 ...
                                 <td>
                                  <?php if( $get_compalaint_result[0]['finish_time']!='0000-00-00 00:00:00') 
								  {
									  echo date('d-M-Y H:i', strtotime($get_compalaint_result[0]['finish_time']));  
								  }?>
                                 </td>
                           </tr>
						    <?php    
          ...
          <!-- BEGIN EXAMPLE TABLE PORTLET-->
		  <?php
		  if ($this->session->userdata('userrole')!='Supervisor' && $this->session->userdata('userrole')!='Admin' && $this->session->userdata('userrole')!='secratery' && $get_compalaint_result[0]['status']=='Pending')
		  {      
		  ?>  
                          ...
                          <div class="col-md-12 form-horizontal">
							...
							<label class="col-md-4 control-label">Start date*:</label>
								<div class="col-md-4">
                                    ...
                                    value="<?php if($get_compalaint_result[0]['reporting_date']!='0000-00-00 00:00:00'){echo date('d-M-Y',strtotime($get_compalaint_result[0]['reporting_date'])); } ?>">
								</div>
							</div>
          ...
          function afterSuccess(my_image)
          {
			  ...
			  $('#loading-img'+my_image).hide(10000, function(){
					...
					$.ajax({
					  url: "<?php echo base_url();?>products/check_file_type/<?php echo $this->uri->segment(3);?>",
					  type: 'POST',
					  data: formdata,
					...
					$.ajax({
					  url: "<?php echo base_url();?>products/check_if_file_uploaded/<?php echo $this->uri->segment(3);?>",
					  type: 'POST',
					  data: formdata,
					  success: function(msg){
                      ...
                      <table class="table table-striped table-bordered table-hover flip-content" id="sample_8">
                        <thead>
                          <tr>
                              ...
                              <?php
								if($obj->is_allowed('FSE') && $get_compalaint_result[0]['status']=='Pending'){ ?>
							  <th>
								   Update
							  </th>
							  <?php }?>
                        ...
                        <?php foreach ($fields_array as $filed){?>
                         <tr class="odd gradeX">
                              ...
                              <?php $my_image='_'.$filed;?>
                                <?php $image=$filed;?>
                              <?php if($obj->is_allowed('FSE') && $get_compalaint_result[0]['status']=='Pending'){ ?>
                              <td>
   ...
   ?>
            ...
            <form method="post" action="<?php echo base_url();?>products/supervisor_mark_pending">
                <input type="hidden" name="complaint_id" value="<?php echo $this->uri->segment(3);?>" />
                <input type="submit" value="Mark Pending" onclick="return check_status()"  class="btn btn-danger" />
            </form>
			...
			function check_status(){
				status = '<?php echo $get_compalaint_result[0]['status'];?>';
					  ...
					  {
						  alert('Current Status is Not Pending Verification, You are Not Allowed to do the current action!');
						  return false;
					  }
			}
            ...
            <script>
			  function check_uploaded()
			  {
				  ...
				  status = '<?php echo $get_compalaint_result[0]['status'];?>';
					  if(status !='Pending Verification')
					  {
						  alert('Currunt Status is Not Pending Verification, You are Not Allowed to Submit!');
						  return false;
					  }
				   // Start date should be changed.
				  var start_date = $('.start_date').val();
				  if(start_date=='30-Nov--0001' || start_date=='01-Jan-1970')
				  {
					   alert('Start Date Not Updated!');
					  return false;
				  }
                      ...
                      <div class="row">
                        <div class="col-md-10">
                                ...
                                <select class="form-controle" name="status" style="width:100%">
                                    ...
                                    <option value="Completed" <?php if($get_compalaint_result[0]['status']=="Completed") { echo "Selected";}?>>
                                    	Completed
                                    </option>
