...
?>
        ...
        <div class="col-md-12"> 
          ...
          <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php /*if ($is_sap) echo base_url().'complaint/insert_dvr_sap';
																								else*/ echo base_url().'complaint/insert_dvr_engineer';?>">
