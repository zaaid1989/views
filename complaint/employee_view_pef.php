				...
				?>
                  <tr class="odd gradeX">
					...
					<?php
							...
							?>
                    <td> <a href="<?php echo base_url();?>complaint/pef_employee/<?php echo $result[0]['id'];?>/<?php echo $schedule3[0]['pk_pef_schedule_id']?>/<?php echo $result[0]['userrole']?>/<?php echo  $result[0]['id']?>" class="btn btn-default">PEF Form</a> </td>
				  ...
				  else if($result[0]['userrole']=="Supervisor")
				  {
					...
					$myquery=$this->db->query($rty);
                      ...
                      <?php
								...
								//echo $schedule3[0]['pk_pef_schedule_id'];
							?>
                          <a href="<?php echo base_url();?>complaint/pef_employee/<?php echo $engineer['id'];?>/<?php echo $schedule3[0]['pk_pef_schedule_id'];?>/<?php echo $result[0]['userrole']?>/<?php echo $result[0]['id']?>" class="btn btn-default">
                            PEF Form
                          </a> 
                      </td>
