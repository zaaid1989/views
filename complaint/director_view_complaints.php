					...
					<!--				<th>
                              ...
                              <tbody>
                                <?php
									  ...
									  WHERE tbl_complaints.complaint_nature='complaint' AND tbl_complaints.status NOT IN ('Pending Verification','Pending SPRF', 'Closed','Pending Registration') 
					...
					<!--				<th>
                              ...
                              <tbody>
                                <?php
									  ...
									  WHERE tbl_complaints.complaint_nature='complaint' AND tbl_complaints.status  IN ('Pending Verification') 
					...
					<!--				<th>
                              ...
                              <tbody>
                                <?php
									  ...
									  WHERE tbl_complaints.complaint_nature='complaint' AND tbl_complaints.status  IN ('Pending SPRF') 
					...
					<!--				<th>
                              ...
                              <tbody>
                                <?php
									  ...
									  WHERE tbl_complaints.complaint_nature='complaint' AND tbl_complaints.status  IN ('Closed') 
