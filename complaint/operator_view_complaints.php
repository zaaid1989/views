                          ...
                          <div class="portlet-body">
                            <div class="table-toolbar">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="btn-group">
                                    <a href="<?php echo base_url();?>complaint/add_complaint/o" id="sample_editable_1_new" class="btn red-intense"> Add New <i class="fa fa-plus"></i> </a>
                                  </div>
                                </div>
                              ...
                              <tbody>
                                <?php
									  ...
									  if (sizeof($dbresResult) == "0") {
										  ...
										  <?php /*
                                          <td>
                                          <a class="btn btn-default" href="<?php echo base_url();?>complaint/ts_report_director/<?php echo $complaint_list["pk_complaint_id"] ?>">
                                          	Open Form
                                          </a>
                                          </td> */?>
