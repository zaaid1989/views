                              ...
                              <tbody>
                                <?php
									...
									<!--	  <td>
                                          ...
                                          href="<?php echo base_url();?>complaint/pm_form/<?php echo $complaint_list["pk_complaint_id"] ?>">
                                          	PM Form &nbsp;
											<i class="fa fa-eye"></i>
                                          </a>
									<?php if($this->session->userdata('userrole')=='Admin') {?>
                                          <a class="btn btn-sm default purple"  
                                            href="<?php echo base_url();?>complaint/update_pm/<?php echo $complaint_list["pk_complaint_id"];?>">
										  ...
										  <a class="btn btn-sm default red-thunderbird" onClick="return confirm('Are you sure you want to delete?')" 
                                            href="<?php echo base_url();?>complaint/delete_pm/<?php echo $complaint_list["pk_complaint_id"];?>">
