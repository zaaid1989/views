<?php $this->load->view('header');?>
        ...
        <div class="col-md-12"> 
          ...
          <div class="portlet box grey-cascade">
           ...
           <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>complaint/insert_aux_equipment_registration">
            ...
            <div class="form-body">
			  ...
			  <script type="text/javascript">
				function select_vendor(category)
				{
				  ...
				  $.ajax({
					url: "<?php echo base_url();?>complaint/vendor_based_on_product_2_ajax",
					type: 'POST',
					data: formdata,
				...
				*/
				...
				function show_main(customer_id)
				{
				  ...
				  $.ajax({
					url: "<?php echo base_url();?>complaint/main_based_on_customer_ajax",
					type: 'POST',
					data: formdata,
					success: function(msg){
						//these two are inner ajax
