			...
			<div class="row inbox">
				<div class="col-md-2">
					<ul class="inbox-nav margin-bottom-10">
						...
						<li class="inbox active">
							...
							Inbox
                            <span class="message_noti_up_badge" style="color:#fff;">
                              (
                                 <span class="message_noti_up" style="margin-right:0;color:#fff;">
								 	<?php echo $unread;?>
                                 </span>
                               )
                               </span>
						...
						<li class="sent">
							<a class="btn" href="<?php echo base_url()?>inbox/sentmessages/0" data-title="Sent">
							Sent </a>
							<b></b>
						</li>
						<li class="trash">
							<a class="btn" href="<?php echo base_url()?>inbox/trash/0" data-title="Trash">
							Trash </a>
							<b></b>
						</li>
					</ul>
				...
				<div class="col-md-10">
					<div class="inbox-header">
						...
						<form class="form-inline pull-right" action="<?php echo base_url();?>inbox/search_message" method="post">
							<div class="input-group input-medium">
								<input type="text" class="form-control" placeholder="Search messages" name="searchmessage">
					...
					<div class="inbox-content">
                        ...
                        <div class="inbox-header inbox-view-header">
                          <h1 class="pull-left"><?php echo $subject; ?> <a href="#">
                          Inbox </a>
                          </h1>
                      ...
                      <div class="inbox-view-info">
                          <div class="row">
                              <div class="col-md-7">
                                  <?php $dbres = $this->db->query("SELECT * FROM user  WHERE `id` = '".$from."'");
									$dbresResult=$dbres->result_array();?>
                                    <?php
                                    	if(empty($dbresResult[0]['image']))
										{
											$user_image="noimage.jpg";
										}
										else
										{
											$user_image	=	$dbresResult[0]['id'].".".$dbresResult[0]['image'];
										}
									?>
                                  <img width="29" height="29" 
                                  src="<?php echo base_url();?>usersimages/<?php echo $user_image;?>">
                                  <span class="bold">
                                  <?php echo $dbresResult[0]["first_name"];?> </span>
                                  <span>
                                  <?php echo $dbresResult[0]["email"];?> </span>
                                  to <span class="bold">
                                  me </span>
                                  
                                  on <?php echo date('h:i a M Y', strtotime($time));?>
                              </div>
                              <div class="col-md-5 inbox-info-btn">
                                  <div class="btn-group">
                                      <button data-messageid="23" class="btn blue reply-btn" onClick="window.location.href='<?php echo base_url();?>inbox/compose'">
                                      ...
                                      <ul class="dropdown-menu pull-right">
                                          <li>
                                              <a href="<?php echo base_url();?>inbox/compose" data-messageid="23" class="reply-btn">
                                              <i class="fa fa-reply"></i> Reply </a>
                                          </li>
                                          
                                          <li>
                                              <a href="<?php echo base_url();?>inbox/delete/<?php echo $id; ?>">
