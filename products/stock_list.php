                    ...
                    <div class="row">
                      <div class="col-md-12"> 
                        ...
                        <div class="portlet box grey-gallery">
						  ...
						  <!-- For searching with office -->
						  <div class="row">
                            	<form method="get" action="<?php echo base_url();?>products/stock_list">
                                <div class="col-md-4">
                            		<div class="form-group">
                                        ...
                                        <select name="office" id="office" class="form-control" required>
                                            ...
                                            <option value="0" 
											<?php if(isset($_GET['office']) && $_GET['office']==0){ echo 'selected="selected"';}?>>
                                            	ALL
                                            </option>
											<?php 
                                            ...
                                            foreach($maxval as $val)
                                            {
												...
												<?php if(isset($_GET['office']) && $_GET['office']==$val['pk_office_id']){ echo 'selected="selected"';}?>>
                              ...
                              <tbody>
								...
								else 
								{
								  foreach ($rt22 as $get_users_list) 
								  {
									  $count_parts = 0;
									//  echo sizeof($rt22);
									 // echo $get_users_list['pk_part_id']."<br/>";
									...
									$stock = $this->db->query("select SUM(stock) AS stock from tbl_stock where fk_office_id = '".$office_id."' 
												  							 AND fk_part_id='".$get_users_list['pk_part_id']."'");
                                                  $stock_result = $stock->result_array();
												  /* for office stock begin */
												  if($office_id!=0 && $stock_result[0]['stock']==0) continue;
												  /* for office stock end */
