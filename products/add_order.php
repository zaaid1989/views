        ...
        <div class="col-md-12">
                ...
                <div class="portlet box green-seagreen">
                  ...
                  <?php
                   ...
                   <!-- BEGIN FORM-->
            <form action="<?php echo base_url();?>products/spare_part_order_insert" class="form-horizontal" method="post"  enctype="multipart/form-data">
                <div class="form-body">
				<div class="">
				<!--
	  <h3>
...
/*  */                                     } 
				 ...
				 function select_description(part_id)
				 {
					...
					$.ajax({
					url: "<?php echo base_url();?>products/office_table_ajax_two",
					type: 'POST',
					data: formdata2,
					success: function(msg){
