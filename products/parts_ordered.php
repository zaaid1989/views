					  ...
					  <?php
                        ...
                        <div class="portlet light bg-inverse">
						  ...
						  <div class="row">
                                <div class="col-md-6">
                                  <div class="btn-group">
                                    <a href="<?php echo base_url();?>products/add_order" class="btn green"> Add Order <i class="fa fa-plus"></i> </a>
                                  </div>
                                </div>
							</div>
                      ...
                      <tbody>
						...
						foreach ($result AS $order) {
							...
							<a class="btn btn-sm default green-jungle"  
											href="<?php echo base_url();?>products/spare_part_stock_entry/<?php echo $order["fk_part_id"];?>">
											  Stock Entry <i class="fa fa-cog"></i>
							</a>
							<a class="btn btn-sm default blue"   
											href="<?php echo base_url();?>products/update_order/<?php echo $order["pk_order_id"];?>">
											  Update Order <i class="fa fa-edit"></i>
											</a>
							<a class="btn btn-sm default purple-seance" 
											href="<?php echo base_url();?>products/ledger?part=<?php echo $order["fk_part_id"];?>">
											  Ledger 
											</a>
							  <a class="btn btn-sm red-thunderbird"  
							  href="<?php echo base_url();?>products/delete_order/<?php echo $order["pk_order_id"]; ?>"
